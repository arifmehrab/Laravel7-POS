    ...
    <div class="col-lg-12">
       <div class="card">
            <div class="card-body">
                  ...
                  <!---- From start ---->
                  <form class="form" action="{{ route('unit.update', $unitsEdit->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                      <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                       <div class="form-group">
                                          <label>Unit Name Example['KG,PIC,GRAM,LITTER ETC']</label>
                                           <input type="text" name="name" class="form-control @error('name') Invalid @enderror" value="{{ $unitsEdit->name }}">
                                           @error('name')
